        ...
        while (true) {
            try {
                ...
                if (req.code == RequestModel.SAVE_PRODUCT_REQUEST) {
                    ...
                    System.out.println("The Client saves a product");
                ...
                if (req.code == RequestModel.ORDER_REQUEST) {

                    System.out.println("The Client saves an order");
                    OrderModel model =  gson.fromJson(req.body, OrderModel.class);
                    dao.saveOrder(model);
